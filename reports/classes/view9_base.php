...
/**
 * Table class for view9
 */
class view9_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		$this->TableVar = 'view9_base';
		$this->TableName = 'view9';
		$this->TableType = 'VIEW';
		...
		// STATE
		$this->STATE = new ReportField('view9_base', 'view9', 'x_STATE', 'STATE', '`STATE`', 200, -1, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->STATE->Lookup = new ReportLookup('STATE', 'view9_base', TRUE, 'STATE', ["STATE","","",""], [], [], [], [], [], [], '`STATE` ASC', '');
		$this->STATE->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['STATE'] = &$this->STATE;

		// CITY
		$this->CITY = new ReportField('view9_base', 'view9', 'x_CITY', 'CITY', '`CITY`', 200, -1, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->CITY->Lookup = new ReportLookup('CITY', 'view9_base', TRUE, 'CITY', ["CITY","","",""], [], [], [], [], [], [], '`CITY` ASC', '');
		$this->CITY->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['CITY'] = &$this->CITY;

		// AREA
		$this->AREA = new ReportField('view9_base', 'view9', 'x_AREA', 'AREA', '`AREA`', 200, -1, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->AREA->Lookup = new ReportLookup('AREA', 'view9_base', TRUE, 'AREA', ["AREA","","",""], [], [], [], [], [], [], '`AREA` ASC', '');
		$this->AREA->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['AREA'] = &$this->AREA;

		// BROKER NAME
		$this->BROKER_NAME = new ReportField('view9_base', 'view9', 'x_BROKER_NAME', 'BROKER NAME', '`BROKER NAME`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BROKER_NAME->Sortable = TRUE; // Allow sort
		$this->BROKER_NAME->DateFilter = "";
		$this->fields['BROKER NAME'] = &$this->BROKER_NAME;

		// OWNER NAME
		$this->OWNER_NAME = new ReportField('view9_base', 'view9', 'x_OWNER_NAME', 'OWNER NAME', '`OWNER NAME`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->OWNER_NAME->Sortable = TRUE; // Allow sort
		$this->OWNER_NAME->DateFilter = "";
		$this->fields['OWNER NAME'] = &$this->OWNER_NAME;

		// BROKER MOBILE
		$this->BROKER_MOBILE = new ReportField('view9_base', 'view9', 'x_BROKER_MOBILE', 'BROKER MOBILE', '`BROKER MOBILE`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BROKER_MOBILE->Sortable = TRUE; // Allow sort
		$this->BROKER_MOBILE->DateFilter = "";
		$this->fields['BROKER MOBILE'] = &$this->BROKER_MOBILE;

		// BROKER EMAIL
		$this->BROKER_EMAIL = new ReportField('view9_base', 'view9', 'x_BROKER_EMAIL', 'BROKER EMAIL', '`BROKER EMAIL`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BROKER_EMAIL->Sortable = TRUE; // Allow sort
		$this->BROKER_EMAIL->DateFilter = "";
		$this->fields['BROKER EMAIL'] = &$this->BROKER_EMAIL;

		// LANDMARK
		$this->LANDMARK = new ReportField('view9_base', 'view9', 'x_LANDMARK', 'LANDMARK', '`LANDMARK`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LANDMARK->Sortable = TRUE; // Allow sort
		$this->LANDMARK->DateFilter = "";
		$this->fields['LANDMARK'] = &$this->LANDMARK;

		// PRICE
		$this->PRICE = new ReportField('view9_base', 'view9', 'x_PRICE', 'PRICE', '`PRICE`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PRICE->Sortable = TRUE; // Allow sort
		$this->PRICE->DateFilter = "";
		$this->fields['PRICE'] = &$this->PRICE;

		// DEPOSITE AMOUNT
		$this->DEPOSITE_AMOUNT = new ReportField('view9_base', 'view9', 'x_DEPOSITE_AMOUNT', 'DEPOSITE AMOUNT', '`DEPOSITE AMOUNT`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DEPOSITE_AMOUNT->Sortable = TRUE; // Allow sort
		$this->DEPOSITE_AMOUNT->DateFilter = "";
		$this->fields['DEPOSITE AMOUNT'] = &$this->DEPOSITE_AMOUNT;

		// PLOT NUMBER
		$this->PLOT_NUMBER = new ReportField('view9_base', 'view9', 'x_PLOT_NUMBER', 'PLOT NUMBER', '`PLOT NUMBER`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PLOT_NUMBER->Sortable = TRUE; // Allow sort
		$this->PLOT_NUMBER->DateFilter = "";
		$this->fields['PLOT NUMBER'] = &$this->PLOT_NUMBER;

		// ROOMS
		$this->ROOMS = new ReportField('view9_base', 'view9', 'x_ROOMS', 'ROOMS', '`ROOMS`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ROOMS->Sortable = TRUE; // Allow sort
		$this->ROOMS->DateFilter = "";
		$this->fields['ROOMS'] = &$this->ROOMS;

		// ADDRESS
		$this->ADDRESS = new ReportField('view9_base', 'view9', 'x_ADDRESS', 'ADDRESS', '`ADDRESS`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ADDRESS->Sortable = TRUE; // Allow sort
		$this->ADDRESS->DateFilter = "";
		$this->fields['ADDRESS'] = &$this->ADDRESS;

		// ACCOMMODATION
		$this->ACCOMMODATION = new ReportField('view9_base', 'view9', 'x_ACCOMMODATION', 'ACCOMMODATION', '`ACCOMMODATION`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ACCOMMODATION->Sortable = TRUE; // Allow sort
		$this->ACCOMMODATION->DateFilter = "";
		$this->fields['ACCOMMODATION'] = &$this->ACCOMMODATION;

		// DESCRIPTION
		$this->DESCRIPTION = new ReportField('view9_base', 'view9', 'x_DESCRIPTION', 'DESCRIPTION', '`DESCRIPTION`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DESCRIPTION->Sortable = TRUE; // Allow sort
		$this->DESCRIPTION->DateFilter = "";
		$this->fields['DESCRIPTION'] = &$this->DESCRIPTION;

		// IMAGE
		$this->IMAGE = new ReportField('view9_base', 'view9', 'x_IMAGE', 'IMAGE', '`IMAGE`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IMAGE->Sortable = TRUE; // Allow sort
		$this->IMAGE->DateFilter = "";
		$this->fields['IMAGE'] = &$this->IMAGE;

		// STATUS
		$this->STATUS = new ReportField('view9_base', 'view9', 'x_STATUS', 'STATUS', '`STATUS`', 3, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->_sqlFrom <> "") ? $this->_sqlFrom : "`view9`";
	}
