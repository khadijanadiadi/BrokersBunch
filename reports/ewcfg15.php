...
define(PROJECT_NAMESPACE . "PROJECT_NAME", "bokerbunchF"); // Project name
define(PROJECT_NAMESPACE . "CONFIG_FILE_FOLDER", PROJECT_NAME); // Config file name
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'tzUDt0obtjw4Yz1f'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phprptcss/bokerbunchF.css"); // Project stylesheet file name
...
$PROJECT_ID = "{D54C8CFC-831E-4677-9FFE-3A9FCE329EA1}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "newrenti", "qs" => "`", "qe" => "`");
