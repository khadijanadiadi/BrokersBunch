...
<!-- <div class="row"> -->			
  <div class="col-md-11 col-xs-12 col-sm-12"><br>  	
  	<div class="alert alert-info" role="alert">
		...
		?>
  		<h2 class="text-center">Appartment Registeration</h2>
  		<form action="" method="post" enctype="multipart/form-data">
		  	 <div class="row">
		  	 	...
		  	 	<div class="col-md-4">
				  <div class="form-group">
				    <label for="apartment_name">Appartment Name</label>
			...
			<div class="row">
			 ...
			 <div class="row">			 	
				<div class="col-md-12"> 
					<div class="form-group">
						<a onclick="addMoreRows(this.form);" class="btn btn-info btn-sm">Other Details</a>
