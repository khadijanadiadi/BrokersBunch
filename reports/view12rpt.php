...
// Form object
var fview12rpt = currentForm = new ew.Form("fview12rpt");

// Validate method
fview12rpt.validate = function() {
...
fview12rpt.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!

	// Your custom validation code here, return false if invalid.
	return true;
}
<?php if (CLIENT_VALIDATE) { ?>
fview12rpt.validateRequired = true; // Uses JavaScript validation
<?php } else { ?>
fview12rpt.validateRequired = false; // No JavaScript validation
<?php } ?>

// Use Ajax
fview12rpt.lists["x_ACCOMMODATION"] = <?php echo $view12_rpt->ACCOMMODATION->Lookup->toClientList() ?>;
fview12rpt.lists["x_ACCOMMODATION"].popupValues = <?php echo json_encode($view12_rpt->ACCOMMODATION->SelectionList) ?>;
fview12rpt.lists["x_ACCOMMODATION"].popupOptions = <?php echo JsonEncode($view12_rpt->ACCOMMODATION->popupOptions()) ?>;
fview12rpt.lists["x_ACCOMMODATION"].options = <?php echo JsonEncode($view12_rpt->ACCOMMODATION->lookupOptions()) ?>;
</script>
<?php } ?>
<?php if ($Page->Export == "" && !$Page->DrillDown && !$DashboardReport) { ?>
<script>
...
<div id="ew-center" class="<?php echo $view12_rpt->CenterContentClass ?>">
<?php } ?>
...
<?php
	...
	$Page->renderRow();
?>
<form name="fview12rpt" id="fview12rpt" class="form-inline ew-form ew-ext-filter-form" action="<?php echo CurrentPageName() ?>">
<?php $searchPanelClass = ($Page->Filter <> "") ? " show" : " show"; ?>
<div id="fview12rpt-search-panel" class="ew-search-panel collapse<?php echo $searchPanelClass ?>">
...
<div class="input-group">
	<select class="custom-select ew-custom-select" data-table="view12" data-field="x_ACCOMMODATION" data-value-separator="<?php echo $Page->ACCOMMODATION->displayValueSeparatorAttribute() ?>" id="x_ACCOMMODATION" name="x_ACCOMMODATION"<?php echo $Page->ACCOMMODATION->editAttributes() ?>>
...
<script>
fview12rpt.filterList = <?php echo $Page->getFilterList() ?>;
</script>
<!-- Search form (end) -->
<?php } ?>
...
<!-- Report grid (begin) -->
<?php if ($Page->Export <> "pdf") { ?>
<div id="gmp_view12" class="<?php if (IsResponsiveLayout()) { echo "table-responsive "; } ?>ew-grid-middle-panel">
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="AREA"><div class="view12_AREA"><span class="ew-table-header-caption"><?php echo $Page->AREA->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="AREA">
<?php if ($Page->sortUrl($Page->AREA) == "") { ?>
		<div class="ew-table-header-btn view12_AREA">
			<span class="ew-table-header-caption"><?php echo $Page->AREA->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer view12_AREA" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->AREA) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->AREA->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="STATE"><div class="view12_STATE"><span class="ew-table-header-caption"><?php echo $Page->STATE->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="STATE">
<?php if ($Page->sortUrl($Page->STATE) == "") { ?>
		<div class="ew-table-header-btn view12_STATE">
			<span class="ew-table-header-caption"><?php echo $Page->STATE->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer view12_STATE" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->STATE) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->STATE->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="CITY"><div class="view12_CITY"><span class="ew-table-header-caption"><?php echo $Page->CITY->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="CITY">
<?php if ($Page->sortUrl($Page->CITY) == "") { ?>
		<div class="ew-table-header-btn view12_CITY">
			<span class="ew-table-header-caption"><?php echo $Page->CITY->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer view12_CITY" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->CITY) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->CITY->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="BROKER_NAME"><div class="view12_BROKER_NAME"><span class="ew-table-header-caption"><?php echo $Page->BROKER_NAME->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="BROKER_NAME">
<?php if ($Page->sortUrl($Page->BROKER_NAME) == "") { ?>
		<div class="ew-table-header-btn view12_BROKER_NAME">
			<span class="ew-table-header-caption"><?php echo $Page->BROKER_NAME->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer view12_BROKER_NAME" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->BROKER_NAME) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->BROKER_NAME->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="OWNER_NAME"><div class="view12_OWNER_NAME"><span class="ew-table-header-caption"><?php echo $Page->OWNER_NAME->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="OWNER_NAME">
<?php if ($Page->sortUrl($Page->OWNER_NAME) == "") { ?>
		<div class="ew-table-header-btn view12_OWNER_NAME">
			<span class="ew-table-header-caption"><?php echo $Page->OWNER_NAME->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer view12_OWNER_NAME" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->OWNER_NAME) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->OWNER_NAME->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="BROKER_MOBILE"><div class="view12_BROKER_MOBILE"><span class="ew-table-header-caption"><?php echo $Page->BROKER_MOBILE->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="BROKER_MOBILE">
<?php if ($Page->sortUrl($Page->BROKER_MOBILE) == "") { ?>
		<div class="ew-table-header-btn view12_BROKER_MOBILE">
			<span class="ew-table-header-caption"><?php echo $Page->BROKER_MOBILE->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer view12_BROKER_MOBILE" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->BROKER_MOBILE) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->BROKER_MOBILE->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="LANDMARK"><div class="view12_LANDMARK"><span class="ew-table-header-caption"><?php echo $Page->LANDMARK->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="LANDMARK">
<?php if ($Page->sortUrl($Page->LANDMARK) == "") { ?>
		<div class="ew-table-header-btn view12_LANDMARK">
			<span class="ew-table-header-caption"><?php echo $Page->LANDMARK->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer view12_LANDMARK" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->LANDMARK) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->LANDMARK->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="PRICE"><div class="view12_PRICE"><span class="ew-table-header-caption"><?php echo $Page->PRICE->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="PRICE">
<?php if ($Page->sortUrl($Page->PRICE) == "") { ?>
		<div class="ew-table-header-btn view12_PRICE">
			<span class="ew-table-header-caption"><?php echo $Page->PRICE->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer view12_PRICE" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->PRICE) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->PRICE->caption() ?></span>
...
<?php } ?>
<?php } ?>
<?php if ($Page->POLT_NUMBER->Visible) { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="POLT_NUMBER"><div class="view12_POLT_NUMBER"><span class="ew-table-header-caption"><?php echo $Page->POLT_NUMBER->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="POLT_NUMBER">
<?php if ($Page->sortUrl($Page->POLT_NUMBER) == "") { ?>
		<div class="ew-table-header-btn view12_POLT_NUMBER">
			<span class="ew-table-header-caption"><?php echo $Page->POLT_NUMBER->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer view12_POLT_NUMBER" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->POLT_NUMBER) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->POLT_NUMBER->caption() ?></span>
			<span class="ew-table-header-sort"><?php if ($Page->POLT_NUMBER->getSort() == "ASC") { ?><i class="fa fa-sort-up"></i><?php } elseif ($Page->POLT_NUMBER->getSort() == "DESC") { ?><i class="fa fa-sort-down"></i><?php } ?></span>
		</div>
<?php } ?>
	</td>
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="APARTMENT_NAME"><div class="view12_APARTMENT_NAME"><span class="ew-table-header-caption"><?php echo $Page->APARTMENT_NAME->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="APARTMENT_NAME">
<?php if ($Page->sortUrl($Page->APARTMENT_NAME) == "") { ?>
		<div class="ew-table-header-btn view12_APARTMENT_NAME">
			<span class="ew-table-header-caption"><?php echo $Page->APARTMENT_NAME->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer view12_APARTMENT_NAME" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->APARTMENT_NAME) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->APARTMENT_NAME->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="APARTMENT_NO_"><div class="view12_APARTMENT_NO_"><span class="ew-table-header-caption"><?php echo $Page->APARTMENT_NO_->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="APARTMENT_NO_">
<?php if ($Page->sortUrl($Page->APARTMENT_NO_) == "") { ?>
		<div class="ew-table-header-btn view12_APARTMENT_NO_">
			<span class="ew-table-header-caption"><?php echo $Page->APARTMENT_NO_->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer view12_APARTMENT_NO_" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->APARTMENT_NO_) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->APARTMENT_NO_->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="ROOMS"><div class="view12_ROOMS"><span class="ew-table-header-caption"><?php echo $Page->ROOMS->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="ROOMS">
<?php if ($Page->sortUrl($Page->ROOMS) == "") { ?>
		<div class="ew-table-header-btn view12_ROOMS">
			<span class="ew-table-header-caption"><?php echo $Page->ROOMS->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer view12_ROOMS" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->ROOMS) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->ROOMS->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="FLOOR"><div class="view12_FLOOR"><span class="ew-table-header-caption"><?php echo $Page->FLOOR->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="FLOOR">
<?php if ($Page->sortUrl($Page->FLOOR) == "") { ?>
		<div class="ew-table-header-btn view12_FLOOR">
			<span class="ew-table-header-caption"><?php echo $Page->FLOOR->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer view12_FLOOR" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->FLOOR) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->FLOOR->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="PURPOSE"><div class="view12_PURPOSE"><span class="ew-table-header-caption"><?php echo $Page->PURPOSE->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="PURPOSE">
<?php if ($Page->sortUrl($Page->PURPOSE) == "") { ?>
		<div class="ew-table-header-btn view12_PURPOSE">
			<span class="ew-table-header-caption"><?php echo $Page->PURPOSE->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer view12_PURPOSE" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->PURPOSE) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->PURPOSE->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="ADDRESS"><div class="view12_ADDRESS"><span class="ew-table-header-caption"><?php echo $Page->ADDRESS->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="ADDRESS">
<?php if ($Page->sortUrl($Page->ADDRESS) == "") { ?>
		<div class="ew-table-header-btn view12_ADDRESS">
			<span class="ew-table-header-caption"><?php echo $Page->ADDRESS->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer view12_ADDRESS" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->ADDRESS) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->ADDRESS->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="ACCOMMODATION"><div class="view12_ACCOMMODATION"><span class="ew-table-header-caption"><?php echo $Page->ACCOMMODATION->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="ACCOMMODATION">
<?php if ($Page->sortUrl($Page->ACCOMMODATION) == "") { ?>
		<div class="ew-table-header-btn view12_ACCOMMODATION">
			<span class="ew-table-header-caption"><?php echo $Page->ACCOMMODATION->caption() ?></span>
	<?php if (!$DashboardReport) { ?>
			<a class="ew-table-header-popup" title="<?php echo $ReportLanguage->phrase("Filter"); ?>" onclick="ew.showPopup.call(this, event, { id: 'x_ACCOMMODATION', form: 'fview12rpt', name: 'view12_ACCOMMODATION', range: false, from: '<?php echo $Page->ACCOMMODATION->RangeFrom; ?>', to: '<?php echo $Page->ACCOMMODATION->RangeTo; ?>' });" id="x_ACCOMMODATION<?php echo $Page->Counts[0][0]; ?>"><span class="icon-filter"></span></a>
	<?php } ?>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer view12_ACCOMMODATION" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->ACCOMMODATION) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->ACCOMMODATION->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="DESCRIPTION"><div class="view12_DESCRIPTION"><span class="ew-table-header-caption"><?php echo $Page->DESCRIPTION->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="DESCRIPTION">
<?php if ($Page->sortUrl($Page->DESCRIPTION) == "") { ?>
		<div class="ew-table-header-btn view12_DESCRIPTION">
			<span class="ew-table-header-caption"><?php echo $Page->DESCRIPTION->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer view12_DESCRIPTION" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->DESCRIPTION) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->DESCRIPTION->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="IMAGE"><div class="view12_IMAGE"><span class="ew-table-header-caption"><?php echo $Page->IMAGE->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="IMAGE">
<?php if ($Page->sortUrl($Page->IMAGE) == "") { ?>
		<div class="ew-table-header-btn view12_IMAGE">
			<span class="ew-table-header-caption"><?php echo $Page->IMAGE->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer view12_IMAGE" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->IMAGE) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->IMAGE->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="STATUS"><div class="view12_STATUS"><span class="ew-table-header-caption"><?php echo $Page->STATUS->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="STATUS">
<?php if ($Page->sortUrl($Page->STATUS) == "") { ?>
		<div class="ew-table-header-btn view12_STATUS">
			<span class="ew-table-header-caption"><?php echo $Page->STATUS->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer view12_STATUS" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->STATUS) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->STATUS->caption() ?></span>
...
<?php } ?>
<?php if ($Page->POLT_NUMBER->Visible) { ?>
		<td data-field="POLT_NUMBER"<?php echo $Page->POLT_NUMBER->cellAttributes() ?>>
<span<?php echo $Page->POLT_NUMBER->viewAttributes() ?>><?php echo $Page->POLT_NUMBER->getViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->APARTMENT_NAME->Visible) { ?>
