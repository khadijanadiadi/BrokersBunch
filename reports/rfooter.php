...
<div id="ew-report-url-dialog" class="modal"><div class="modal-dialog modal-lg"><div class="modal-content"><div class="modal-header"><h4 class="modal-title"></h4></div>
<div class="modal-body">
<?php include_once "rurl12.php" ?>
</div><div class="modal-footer"><button type="button" class="btn btn-primary ew-button"><?php echo $ReportLanguage->phrase("Generate") ?></button><button class="btn btn-default ew-button ew-copy-to-clipboard" data-clipboard-target="#ew-url"><?php echo $ReportLanguage->phrase("CopyToClipboard") ?></button><button type="button" class="btn btn-default ew-button" data-dismiss="modal" aria-hidden="true"><?php echo $ReportLanguage->phrase("CloseBtn") ?></button></div></div></div></div>
<!-- modal dialog -->
